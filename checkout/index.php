...
require_once(__ROOT__.'/util/main.php');
require_once(__ROOT__.'/util/secure_conn.php');
require_once(__ROOT__.'/util/validation.php');

require_once(__ROOT__.'/model/cart.php');
require_once(__ROOT__.'/model/product_db.php');
require_once(__ROOT__.'/model/order_db.php');
require_once(__ROOT__.'/model/customer_db.php');
require_once(__ROOT__.'/model/address_db.php');

if (!isset($_SESSION['user'])) {
    $user = $_SESSION['user'];
    echo 'Checkout User String: ' . $user; 
    $_SESSION['checkout'] = true;
    redirect('../account/account_login_register.php');
//    redirect('../account');
    exit();
}
